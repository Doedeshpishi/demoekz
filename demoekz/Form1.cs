...
namespace demoekz
{
    ...
    {
        using (var filterForm = new FilterForm(taskManager, statusFilter, assigneeFilter, priorityFilter))
        {
            if (filterForm.ShowDialog() == DialogResult.OK)
            {
                statusFilter = filterForm.StatusFilter;
                assigneeFilter = filterForm.AssigneeFilter;
                priorityFilter = filterForm.PriorityFilter;
                LoadTasks();
                    statusFilter = null;
                    assigneeFilter = null;
                    priorityFilter = null;
        ...
        private void LoadTasks()
        {
            try
            {
                var tasks = taskManager.GetTasks(statusFilter, assigneeFilter, priorityFilter);
        ...
        {
            string docxPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "C:\\Users\\student\\Downloads\\demoekz-master\\demoekz\\Demo.docx");
